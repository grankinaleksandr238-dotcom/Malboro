...
# Суперадмины – список ID через запятую в переменной SUPER_ADMINS (например, "123456789,987654321")
                ...
                if category == 'gift':
                    ...
                    if effect:
                        if effect.startswith('tool+'):
                            ...
                            uses_from_item = 1  # детектив одноразовый (quantity)
